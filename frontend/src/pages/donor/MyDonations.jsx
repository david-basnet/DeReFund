      ...
      <DonorLayout>
        <div className="p-6 lg:p-8">
          <div className="bg-white rounded-xl shadow-lg p-8 text-center">
            ...
            <p className="text-gray-800 mb-4 font-dmsans tracking-tight">You need to be logged in to view your donations.</p>
            <Link to="/" className="text-purple hover:text-light-purple underline-animate font-dmsans tracking-tight font-bold">Go to Home</Link>
          </div>
        </div>
      </DonorLayout>
    );
    ...
    <DonorLayout>
      <div className="p-6 lg:p-8">
        <div className="max-w-7xl mx-auto">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-black mb-2 font-playfair tracking-tight">My Donations</h1>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-6 text-white">
              <div className="text-3xl font-bold mb-2 font-playfair tracking-tight">{donations.length}</div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            {loading ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-800 font-dmsans tracking-tight">Loading your donations...</p>
              </div>
            ) : !Array.isArray(donations) || donations.length === 0 ? (
              <div className="text-center py-12 bg-white rounded-2xl shadow-lg">
                <p className="text-gray-800 mb-4 font-dmsans tracking-tight">You haven't made any donations yet.</p>
                <Link
                  to="/campaigns"
                  className="inline-block bg-gradient-to-r from-blue-600 to-blue-800 text-white px-6 py-3 rounded-xl font-bold hover-lift shadow-lg transition-all duration-300 font-dmsans tracking-tight"
                >
                  Browse Campaigns
                </Link>
              </div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="bg-gradient-to-r from-blue-600 to-blue-800">
                      <tr>
                        <th className="px-6 py-4 text-left text-sm font-bold text-white font-dmsans tracking-tight">Campaign</th>
                        ...
                        <tr key={donation.donation_id} className="hover:bg-light-gray transition-colors">
                          <td className="px-6 py-4">
                            <Link
                              ...
                              className="text-blue-600 hover:text-blue-700 font-medium underline-animate font-dmsans tracking-tight"
                            >
                              {donation.campaign?.title || 'Campaign'}
                            </Link>
                          </td>
                          <td className="px-6 py-4 font-bold text-blue-600 font-dmsans tracking-tight">
