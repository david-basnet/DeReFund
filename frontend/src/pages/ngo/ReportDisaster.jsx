        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 tracking-tight flex items-center gap-2">
              ...
              Disaster Management (NGO)
            </h1>
            <p className="text-slate-500 mt-1">
              {view === 'list' ? 'View and manage disaster cases reported by your NGO' : 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {loading ? (
              <div className="col-span-full py-20 flex flex-col items-center justify-center">
                <Loader2 className="w-10 h-10 text-purple animate-spin mb-4" />
              ...
              <div className="col-span-full py-20 bg-white rounded-3xl border-2 border-dashed border-slate-200 flex flex-col items-center justify-center text-center px-6">
                ...
                <p className="text-slate-500 mt-2 max-w-xs">
                  Report disaster situations to initiate relief campaigns and start fundraising.
                </p>
                <button 
                  onClick={handleCreateNew}
                  className="mt-6 text-purple font-bold hover:underline flex items-center gap-1"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-purple/20 focus:border-purple outline-none transition-all"
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={5}
                    className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-purple/20 focus:border-purple outline-none transition-all resize-none"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-purple/20 focus:border-purple outline-none transition-all"
                ...
                <div className="md:col-span-2 border-t border-slate-100 pt-6">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 gap-4 mb-4">
                    ...
                    <button
                      ...
                      className="aspect-square rounded-xl border-2 border-dashed border-slate-200 hover:border-purple hover:bg-slate-50 transition-all flex flex-col items-center justify-center gap-1 text-slate-400 hover:text-purple"
                    >
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-1 focus:ring-purple outline-none"
